package com.svegon.capi.util.event.network;
...
public interface S2CPlayPacketListener extends ClientPlayPacketListener {
    Event<S2CPlayPacketListener> CLIENT_PACKET_RECEIVED_EVENT = EventFactory.createArrayBacked(S2CPlayPacketListener.class,
    ...
    ListenerList<S2CPlayPacketListener> LISTENER_LIST = ListenerCollectionFactory.listenersArrayList(
    ...
    @Override
    default void onVibration(VibrationS2CPacket packet) {

    }

    @Override
    default void onMobSpawn(MobSpawnS2CPacket packet) {
    ...
    @Override
    default void onPaintingSpawn(PaintingSpawnS2CPacket packet) {
    ...
    @Override
    default void onPlaySoundId(PlaySoundIdS2CPacket packet) {
